...
- Prefer Razorpay Blade components and exported Blade icons. Add a wrapper here only when it encodes an enduring Finora product convention, not to restyle a single page.
- UI defaults use Blade-bundled Inter. Preserve tabular numeric formatting for financial values.
